"""Offline utilities for evaluating ranking quality against committee annotations."""
    ...
    for semantic_key, annotation_key in dimension_map.items():
        ...
        for row, annotation in aligned:
            ...
            if annotation_key is None:
                ...
                elif semantic_key == "community_orientation":
                    ys.append(float(annotation.committee_priority or annotation.composite_label))
                else:
