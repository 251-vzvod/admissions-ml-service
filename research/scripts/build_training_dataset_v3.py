...
SOURCE_JSONLS = {
    ...
    "gap_fill_batch_v7": DATA_ROOT / "raw" / "generated" / "gap_fill_batch_v7" / "gap_fill_batch_v7_api_input.jsonl",
}

TRAINING_JSONL = EXPORTS_DIR / "training_dataset_v3.jsonl"
TRAINING_CSV = EXPORTS_DIR / "training_dataset_v3.csv"
MANIFEST_JSON = EXPORTS_DIR / "training_dataset_v3_manifest.json"
...
def origin_language_slice(source_group: str) -> str:
    ...
    if source_group == "gap_fill_batch_v7":
        return "english_direct_with_translated_style_slice"
...
def write_manifest(rows: list[dict[str, Any]]) -> None:
    ...
    manifest = {
        "dataset_name": "training_dataset_v3",
        "generated_from": {
        ...
        "notes": [
            "Candidate-level canonical training table after adding the targeted gap-fill synthetic batch.",
            ...
            "Gap-fill batch v7 intentionally increases coverage of manual-review, insufficient-evidence, no-interview, translated-thinking-English, and support-needed-not-hidden-star slices.",
        ],
    }
