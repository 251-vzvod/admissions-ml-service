...
def main() -> None:
    ...
    parser.add_argument("--output-json", default="research/reports/pairwise_ranker_experiment.json")
    parser.add_argument("--output-md", default="research/reports/pairwise_ranker_experiment.md")
