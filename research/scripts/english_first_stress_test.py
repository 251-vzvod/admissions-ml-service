...
def main() -> None:
    ...
    parser.add_argument("--output-json", default="research/reports/english_first_stress_test.json")
    parser.add_argument("--output-md", default="research/reports/english_first_stress_test.md")
