...
def build_manual_review_batch(
    ...
    return {
        "meta": {
            ...
            "source_candidates_file": "data/candidates.json",
            "source_annotations_file": "data/annotation_pack_draft.json",
            "selection_policy": [
...
def main() -> None:
    ...
    parser.add_argument("--annotations", default="data/annotation_pack_draft.json")
    parser.add_argument("--output", default="data/manual_review_batch_v1.json")
