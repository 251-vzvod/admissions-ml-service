...
def main() -> None:
    ...
    parser.add_argument("--candidates", default="data/candidates_expanded_v1.json")
    parser.add_argument("--scored", default="data/evaluation_pack_final_hackathon_v3/hybrid_scored_results.json")
    parser.add_argument("--annotations", default="data/final_hackathon_annotations_v1.json")
    parser.add_argument("--output-json", default="data/evaluation_pack_final_hackathon_v3/family_aware_validation.json")
    parser.add_argument("--output-md", default="docs/family_aware_validation.md")
