...
def main() -> None:
    ...
    parser.add_argument("--output-json", default="data/evaluation_pack_final_hackathon_v3/english_first_validation.json")
    parser.add_argument("--output-md", default="docs/english_first_validation.md")
